	...
	public static void displayElements() {
		...
		for (int i=0; i<colorRBs.size(); i++) {
			if(colorRBs.get(i).isEnabled()) {
				...
				logger.info("Element " + colorLabelRBs.get(i).getText() + " with index " + i + " is enabled");
			}
			else {	
				System.out.println("Element " + colorLabelRBs.get(i).getText() + " with index " + i + " is disabled");
				logger.info("Element " + colorLabelRBs.get(i).getText() + " with index " + i + " is disabled");
			}
		}
		...
		for (int i=0; i<sportRBs.size(); i++) {
			if(sportRBs.get(i).isEnabled()) {
				...
				logger.info("Element " + sportLabelRBs.get(i).getText() + " with index " + i + " is enabled");
			}
			else {
				System.out.println("Element " + sportLabelRBs.get(i).getText() + " with index " + i + " is disabled");
				logger.info("Element " + sportLabelRBs.get(i).getText() + " with index " + i + " is disabled");
			}
	...
	public static void displaySelectedElements() {
		...
		for (int i=0; i<colorRBs.size(); i++) {
			if(colorRBs.get(i).isSelected()) {
				...
				logger.info("Element " + colorLabelRBs.get(i).getText() + " with index " + i + " is SELECTED");
			}
			else 	{
				System.out.println("Element " + colorLabelRBs.get(i).getText() + " with index " + i + " is not slected");
				logger.info("Element " + colorLabelRBs.get(i).getText() + " with index " + i + " is not slected");
			}
		}
		...
		for (int i=0; i<sportRBs.size(); i++) {
			if(sportRBs.get(i).isSelected()) {
				...
				logger.info("Element " + sportLabelRBs.get(i).getText() + " with index " + i + " is SELECTED");
			}
			else {
				System.out.println("Element " + sportLabelRBs.get(i).getText() + " with index " + i + " is not selected");
				logger.info("Element " + sportLabelRBs.get(i).getText() + " with index " + i + " is not selected");
			}
		}
	}
